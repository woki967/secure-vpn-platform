...
def build_command(name: str, *args: str) -> list[str]:
    # Zwracamy po prostu nazwę i argumenty. 
    # Dzięki parametrowi shell=True poniżej, Windows sam prawidłowo rozwiąże ścieżkę do 'az'.
    return [name, *args]
...
SUBPROCESS_TEXT_KW = {
    ...
    "encoding": "utf-8",
    "errors": "replace",
    "shell": True,  # <-- Ta flaga naprawia problem ze spacjami w 'C:\Program Files' na Windowsie
}
